...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  Recording.create(title:"Don't Get Technical", body: "C3P0 tells off R2D2 for talking jargon.", username: owen.username, user_id: owen.id, image: File.open('app/assets/images/boba-fett.jpg'), audio: File.open('app/assets/c3po_technical.wav'))
  Recording.create(title:"A Piece of Junk", body: "What a piece of junk!", username: owen.username, user_id: owen.id, image: File.open('app/assets/images/wookie.jpg'), audio: File.open('app/assets/luke_junk.wav'))
  Recording.create(title:"Wrrrrh", body: "Chewbacca speaks his mind", username: owen.username, user_id: owen.id, image: File.open('app/assets/images/piett.jpg'), audio: File.open('app/assets/chewbacca_01.wav'))
  Recording.create(title:"Booming Laughter", body: "Jidee Jedi: Jabba laughs in the face of danger", username: beru.username, user_id: beru.id, image: File.open('app/assets/images/at-at.jpg'), audio: File.open('app/assets/jabba_laugh.wav'))
  ...
  Recording.create(title:"Take On The Whole Empire", body: "You were meant to be the Chosen One!", username: dak.username, user_id: dak.id, image: File.open('app/assets/images/endor.jpg'), audio: File.open('app/assets/obiwan_chosenone.wav'))
  Recording.create(title:"Nerfherder", body: "Scruffy looking nerfherder", username: dak.username, user_id: dak.id, image: File.open('app/assets/images/leia.jpg'), audio: File.open('app/assets/nerfherder.wav'))
  Recording.create(title:"Don't Be Too Proud", body: "Don't be too proud of this technological terror you've constructed.", username: greedo.username, user_id: greedo.id, image: File.open('app/assets/images/snow.jpg'), audio: File.open('app/assets/darthvader_technological.wav'))
